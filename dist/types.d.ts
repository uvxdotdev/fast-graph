...
export declare const DEFAULT_NODE_COLOR = "#3498db";
export declare const DEFAULT_NODE_SIZE = 5;
/** Default values for optional edge properties */
export declare const DEFAULT_EDGE_COLOR = "#95a5a6";
export declare const DEFAULT_EDGE_WIDTH = 1;
