...
function __wbg_adapter_1029(arg0, arg1, arg2, arg3) {
    wasm.closure2216_externref_shim(arg0, arg1, arg2, arg3);
}
...
const FastGraphRendererFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_fastgraphrenderer_free(ptr >>> 0, 1));
...
export class FastGraphRenderer {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        FastGraphRendererFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_fastgraphrenderer_free(ptr, 0);
    }
    constructor() {
        const ret = wasm.fastgraphrenderer_new();
        this.__wbg_ptr = ret >>> 0;
        FastGraphRendererFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     */
    init(canvas) {
        const ret = wasm.fastgraphrenderer_init(this.__wbg_ptr, canvas);
        return ret;
    }
    /**
     * @param {number} time
     */
    render(time) {
        wasm.fastgraphrenderer_render(this.__wbg_ptr, time);
    }
    /**
     * @param {number} width
     * @param {number} height
     */
    resize(width, height) {
        wasm.fastgraphrenderer_resize(this.__wbg_ptr, width, height);
    }
    /**
     * @param {number} color1_r
     * @param {number} color1_g
     * @param {number} color1_b
     * @param {number} color1_a
     * @param {number} color2_r
     * @param {number} color2_g
     * @param {number} color2_b
     * @param {number} color2_a
     */
    set_colors(color1_r, color1_g, color1_b, color1_a, color2_r, color2_g, color2_b, color2_a) {
        wasm.fastgraphrenderer_set_colors(this.__wbg_ptr, color1_r, color1_g, color1_b, color1_a, color2_r, color2_g, color2_b, color2_a);
    }
    /**
     * @param {number} r
     * @param {number} g
     ...
     */
    set_color1(r, g, b, a) {
        wasm.fastgraphrenderer_set_color1(this.__wbg_ptr, r, g, b, a);
    }
    /**
     * @param {number} r
     * @param {number} g
     ...
     */
    set_color2(r, g, b, a) {
        wasm.fastgraphrenderer_set_color2(this.__wbg_ptr, r, g, b, a);
    }
    /**
     * @param {string} hex
     */
    set_color1_hex(hex) {
        ...
        wasm.fastgraphrenderer_set_color1_hex(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @param {string} hex
     */
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_closure_wrapper2088 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 782, __wbg_adapter_32);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('fast_graph_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
